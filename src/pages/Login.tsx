    ...
    <div className="min-h-[100dvh] flex flex-col bg-[var(--bg)] font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-[var(--bg2)] p-8 sm:p-10 rounded-xl border border-[var(--border-color)] shadow-2xl relative overflow-hidden">
          ...
          <h1 className="font-serif text-3xl font-bold text-center mb-2 text-[var(--text)] tracking-tight">Welcome Back</h1>
          <p className="text-center text-[var(--text-dim)] mb-8">Sign in to continue your adventure.</p>
          ...
          <div className="mt-8 pt-6 border-t border-[var(--border-color)] text-center text-sm text-[var(--text-dim)] relative z-10">
            ...
            <Link href="/register" className="text-[var(--gold)] font-bold hover:underline uppercase tracking-wider ml-1">
              Register
            </Link>
          </div>
        </div>
